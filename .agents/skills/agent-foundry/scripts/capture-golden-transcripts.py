...
GOLDENS_DIR = os.path.join(os.getcwd(), "evals", "goldens")
SCENARIOS_YAML = os.path.join(os.getcwd(), "evals", "scenarios", "scenarios.yaml")
TRANSCRIPTS_DIR = os.path.join(os.getcwd(), "evals", "goldens", "transcripts")


def get_app_name():
    """Read app name from scenarios.yaml meta section."""
