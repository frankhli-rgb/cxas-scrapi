...
| `evals/simulations/simulations.yaml` | Behavioral goals, tool expectations as descriptions, "MUST cooperate fully", appropriate max_turns |
...
- **Instruction design, callback patterns, anti-patterns:** `skills/build/references/gecx-design-guide.md`
- **Eval YAML formats and test patterns:** `skills/build/references/eval-templates.md`
- **TDD structure, golden vs sim decisions:** `skills/build/references/interview-guide.md`
