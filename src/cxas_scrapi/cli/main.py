...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser_migrate_dfcx.add_argument(
        ...
        help="Default name for the target agent (TUI Mode / Fallback).",
    )
    ...
    e2e_group.add_argument(
        ...
        action="store_true",
        help=(
            "Skip Stage 1 + Stage 2 + Stage 3 optimization passes "
            "(Fast-deploy only)."
        ),
    )
    e2e_group.add_argument(
        ...
        action="store_true",
        help=(
            "Persist intermediate IR bundle JSON for subsequent resumable runs."
        ),
    )
    e2e_group.add_argument(
        "--yes",
    ...
    opt_group.add_argument(
        ...
        help=(
            ...
            "(Default: '0.0.2' for stage 1, '0.0.3' for stage 2, "
            "'0.0.4' for stage 3)."
        ),
    )
    opt_group.add_argument(
    ...
    opt_group.add_argument(
        ...
        action="store_true",
        help=(
            "Stage 3: Compute and print final generative Spoke-Hub "
            "topology without applying."
        ),
    )
