...
def test_sessions_init(mock_client_cls):
    ...
    sessions = Sessions(app_id="projects/p/locations/l/apps/a", deployment_id="d1", version_id="v1")
...
def test_session_id_setup(mock_client_cls):
    ...
    s2 = sessions.session_id_setup("projects/p/locations/l/apps/a/sessions/ex", restart_session=False)
